...
const CreatePoint: React.FC = () => {
    ...
    const [initialPosition, setInitialPosision] = useState<[number, number]>([0, 0]);
    ...
    useEffect(() => {
        ...
        navigator.geolocation.getCurrentPosition(position => {
            ...
            setInitialPosision([latitude, longitude]);
        })
    }, [])
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            <label htmlFor="naemailme">E-mail</label>
                            <input 
                                type="email"
                                name="email"
                                id="email"  
